...
class LoginController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->loginModel = $this->loadModel('auth/LoginsModel');
        $this->data = [];
    }
    public function index()
    {
        ...
        $this->data['view'] = 'clients/auth/login';
        $this->render('clients/layouts/layout_auth', $this->data);
    }
