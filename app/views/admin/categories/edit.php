<section class="container" style="margin-top: 120px; width: 600px;">
    ...
    <form action="<?= linkRoute('admin/submit-sua-danh-muc-bai-viet') ?>" method="post">
        <label for="username" class="form-label fw-semibold mt-2 text-primary-emphasis">
            <i class="fa-solid fa-circle-check"></i>
            Tên danh mục
        </label>
        <div class="input-group has-validation">
            <input value="<?= getValueEdit($pre_data, $dataEdit)['name'] ?>" name="name" type="text" class="form-control <?= invalid($errors, 'name_cate') ?> " id="name_cate">
