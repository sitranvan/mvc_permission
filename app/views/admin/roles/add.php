<section class="container" style="margin-top: 120px; width: 600px;">
    ...
    <form action="<?= linkRoute('admin/submit-them-vai-tro') ?>" method="post">
        <label for="username" class="form-label fw-semibold mt-2 text-primary-emphasis">
            <i class="fa-solid fa-circle-check"></i>
            Tên vai trò
        </label>
        <div class="input-group has-validation">
            <input value="<?= $preData['name'] ?? false ?> " name="name" type="text" class="form-control <?= invalid($errors, 'role') ?> " id="role">
